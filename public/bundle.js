...
var _TraceTool = __webpack_require__(1);

var _TraceTool2 = _interopRequireDefault(_TraceTool);
...
var res = _jquery2.default.getJSON('../src/data/res.js', function (result) {
    console.log(result);
});
new _TraceTool2.default();
console.log('start');
...
var _canvasBoard = __webpack_require__(2);
...
function TraceTool(options) {
	...
	this.choosedLink = [];
	var canvasBoard = this.canvasBoard = new _canvasBoard2.default({
		map: options.map,
		update: self._updata
	});
	this.event();
...
TraceTool.prototype = {
	...
	draceTrace: function draceTrace(res) {
		this.type = 'drawTrace';
		this.data = res.data;
	...
	drawPath: function drawPath(options) {
	...
	getLinkByPos: function getLinkByPos() {},
	event: function event() {
		var self = this;
		this.canvasBoard.addEventListener('click', function (e) {
			var choosedLink = self.getLinkByPos();
		});
	}
};
...
CanvasBoard.prototype = document.querySelector('canvas');
